...
export type User = { id: string; email?: string; user_metadata: { full_name?: string; [key: string]: unknown }; created_at: string }
...
export function AuthProvider({ children }: { children: React.ReactNode }) {
  ...
  return <AuthContext.Provider value={{ session, user, isInitializing, isAdmin: false, signOut, sendMagicLink, signInWithGoogle, signInAsAdmin, signIn, signUp, resetPassword, updatePassword }}>{children}</AuthContext.Provider>
}
