  ...
  return (
    <AuthLayout>
      <div className="bg-white p-8 md:p-10 rounded-3xl shadow-apple border border-gray-200 w-full animate-[fadeIn_0.5s_ease-out]">
        ...
        <div className="pt-6 border-t border-gray-100 text-center text-xs font-medium text-gray-400">
          Your workspace data is protected by Supabase Auth and workspace-level RLS.
        </div>
      </div>
    </AuthLayout>
  );
