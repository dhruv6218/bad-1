...
export const Gateways = () => {
  ...
  const options = [
    { type: "stripe", label: "Stripe", description: "Global cards, Apple Pay, Google Pay", icon: CreditCard, color: "bg-[#635BFF]" },
    { type: "razorpay", label: "Razorpay", description: "UPI, Netbanking, and domestic cards", icon: Zap, color: "bg-[#02042B]" },
    { type: "upi", label: "Static payment link", description: "PayPal, UPI, or hosted checkout URL", icon: LinkIcon, color: "bg-brand-blue" },
  ];
